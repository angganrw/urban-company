      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-4 sm:px-0 group">
        {services.map((services, idx) => (
          ...
          >
            ...
            <Link href="/our-teams">
              <button className="relative -top-1 -left-1 bg-[#1a79af] py-4 px-6 font-medium uppercase text-white transition-all before:absolute before:top-1 before:left-1 before:-z-[1] before:h-full before:w-full before:border-2 before:border-gray-700 before:transition-all before:content-[''] hover:top-0 hover:left-0 before:hover:top-0 before:hover:left-0">
                Lets Talk
              </button>
            </Link>
          </div>
